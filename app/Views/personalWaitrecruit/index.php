                ...
                <div class="float-end" style="width: 40%;">
                    <form>
                        <div class="input-group">
                            <input type="text" class="form-control" name="search" placeholder="ป้อนชื่อจริง หรือ นามสกุล หรือ เลขบัตรปชช." value="<?php echo isset($_GET['search']) ? $_GET['search'] : '' ?>">
                                    ...
                                    <div class="card bg-gradient-secondary" style="width: 18rem;">
                                        <?php foreach ($number as $key => $value) :
                                            ...
                                            elseif ($value['total'] >= 1)
                                                ...
                                                <i class="fas fa-female text-white" style="font-size:50px"></i>
                                                <i class="fas fa-male text-white" style="font-size:50px"></i>
                                            <h2 class="card-subtitle mb-2 text-white float-end">' . $value['total'] . ' ราย</h2>
                                            </div>';
                                        endforeach; ?>
                                    </div>
